...
const recentActivity = [
  { avatar: "👩‍🎓", name: "Priya Sharma", action: "requested mentorship for your ML course", time: "1 hour ago" },
  { avatar: "👨‍💻", name: "Rohan Mehta", action: "submitted project for your review", time: "3 hours ago" },
  { avatar: "👩‍💻", name: "Ananya Singh", action: "asked a question on Data Structures thread", time: "Yesterday" },
];
    ...
    <div className="dashboard-layout">
      ...
      <aside className="sidebar sidebar--teacher">
        ...
        <div className="sidebar-user">
          <div className="user-avatar user-avatar--teacher">{user.avatar}</div>
        ...
        <nav className="sidebar-nav">
          {TEACHER_NAV.map((item) => (
            <button
              key={item.label}
              className={`nav-item ${activeNav === item.label ? "nav-item--active nav-item--active-teacher" : ""}`}
              onClick={() => {
      ...
      <main className="dashboard-main">
        <div className="dashboard-content">
          ...
          {/* Stats — Teacher specific */}
          <div className="stats-grid">
            {[
              { icon: "👥", value: "24", label: "Students" },
              { icon: "📖", value: "7", label: "Projects Posted" },
              { icon: "💬", value: "15", label: "Queries Answered" },
              { icon: "📈", value: "89%", label: "Impact Score" },
            ].map((stat) => (
          ...
          <div className="bottom-grid">
            ...
            <div className="panel">
              ...
              <button className="view-all-btn view-all-btn--teacher">View All Activity →</button>
            </div>
